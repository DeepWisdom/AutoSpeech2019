...
import data.data_utils_v2 as ut
import data.generator_v2 as generator
...
class Model(object):
    def __init__(self, metadata, train_output_path="./", test_input_path="./"):
        ...
        self.autospeech_sampler: AutoSpSamplerNew = None
    ...
    def get_x_data_features_by_sampleidlist(self, cur_sampid_list):
        ...
        if len(cur_need_id_list) > 0:
            ...
            cur_need_x_data_list = ut.pre_trans_wav_update(cur_need_origin_xdata, self.imp_feat_args)
    ...
    def test(self, test_x, remaining_time_budget=None):
        ...
        if self.test_idx == 1 or self.spec_len_status == 2:
            self.test_x_data_report = self.autospeech_eda.get_x_data_report(x_data=test_x)
